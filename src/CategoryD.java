public class CategoryD extends Driver{
    public CategoryD(String person, String thePresenceOfADriversLicense, int experience){
    ...
    public void getMassage(){
        System.out.println("Это водитель категории D - " + person + ". Категория прав - " + thePresenceOfADriversLicense

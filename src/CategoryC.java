public class CategoryC extends Driver{
    public CategoryC(String person, String thePresenceOfADriversLicense, int experience){
    ...
    public void getMassage(){
        System.out.println("Это водитель категории C - " + person + ". Категория прав - " + thePresenceOfADriversLicense
